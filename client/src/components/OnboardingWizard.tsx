      ...
      <DialogContent className="sm:max-w-[600px]" onInteractOutside={(e) => e.preventDefault()}>
        ...
        <div className="space-y-6 py-4">
          ...
          {step === 3 && (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Klipz works best with access to your device features. You can skip this step and grant permissions later from Settings.
              </p>
              <Button 
          ...
          {step === 4 && (
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="reasonForUse">What will you use Klipz for?</Label>
                <Textarea
                  id="reasonForUse"
                  value={reasonForUse}
